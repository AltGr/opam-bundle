This test verify bundling of real package `opam-bundle` of version 0.4.
  ...
  $ opam-bundle "opam-bundle@opam-bundle" --self --opam=2.1 --yes 2>&1 | sed 's/arch =.*/arch = $ARCH/;s/os =.*/os = $OS/;s/os-distribution =.*/os-distribution = $OSDISTRIB/;s/os-version =.*/os-version = $OSVERSION/;s/os-family =.*/os-family = $OSFAMILLY/'
