This test verify basic functionallities of `opam-bundle`. Every package used is a dummy package.
More complex tests on various options could be found in *dummy* directory. Tests with real repositories
