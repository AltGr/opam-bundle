...
Different version of one dummy executable
  $ cat > compile << EOF
...
Trying to bundle two packages `bar` and `foo<3@foo.4`. This should fail, because package with url could be constrainted only with '.' or '='.
