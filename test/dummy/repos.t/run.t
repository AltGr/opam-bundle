...
Bundle package foo with and specifiyng two repositories with `ocaml.4.12` and second repository containing
...
Bundle packages foo and bar with specifiyng three repositories with `foo` and second repository containing `bar`
